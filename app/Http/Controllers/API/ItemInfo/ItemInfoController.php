...
class ItemInfoController extends Controller
{
    ...
    public function getItems(){
        ...
        $items = '';
        if ($request->provId != '') {
            $items = ItemInfo::where('provCode', $request->provId )->relTable()->get();

        }else {
            $items = ItemInfo::relTable()->get();
        }
        if ($request->cityId != null ) {
            $items = ItemInfo::where('citymunCode', $request->cityId )->relTable()->get();
        }
    ...
    public function cat(){
        ...
        $itemInfo = ItemInfo::where('category_id', $request->catId )->relTable()->get();

        $paginated = $this->paginatePage($itemInfo);
    ...
    public function subCat(){
        ...
        $items = ItemInfo::where('subcategory_id', $request->subId )->relTable()->get();
    ...
    public function furtherCat(){
        ...
        $items = ItemInfo::where('further_category_id', $request->furthCat )->relTable()->get();
